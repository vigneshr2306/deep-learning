...
def prepareData(lang1, lang2, vocab1=None, vocab2=None, reverse=False, max_length=50):
    ...
    input_lang, output_lang, pairs = readLangs(
        lang1, lang2, vocab1=vocab1, vocab2=vocab2, reverse=reverse)
...
def testBlueScore(encoder, decoder, pairs):
    ...
    for pair in pairs:
        try:
            ...
            pass
        output_sentence = ' '.join(output_words)
        blue.append(sentence_bleu([output_sentence],
...
if __name__ == '__main__':
    ...
    attn_decoder1 = AttnDecoderRNN(
        hidden_size, output_lang.n_words, dropout_p=0.2).to(device)
    if arg.mode == 'train':
